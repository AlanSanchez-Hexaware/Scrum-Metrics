...
export class UserService {
  ...
  setUser(name: string, email: string, username: string, password: string) {
    ...
    this.http.post<{error: boolean, message: string}>('https://scrum-metrics.herokuapp.com/api/postuser', user).subscribe((responseData) => {
  ...
  loginUser(username: string, password: string) {
    ...
    this.http.post<{error: boolean, message: string}>('https://scrum-metrics.herokuapp.com/api/login', userLog).subscribe((responseData) => {
    if (responseData.error) {
        alert(responseData.message);
        return;
      } else {
  ...
  getUserInfo(username: string) {
    ...
    ('https://scrum-metrics.herokuapp.com/api/user', user).subscribe((responseData) => {
  ...
  getUsersM() {
    this.http.get('https://scrum-metrics.herokuapp.com/api/usersquery').subscribe((responseData) => {
  ...
  updateName(username: string, name: string) {
    ...
    this.http.put<{error: boolean}>('https://scrum-metrics.herokuapp.com/api/nameupd', userupd).subscribe((responseData) => {
      if (responseData.error) {
  ...
  updateMail(username: string, email: string) {
    ...
    this.http.put<{error: boolean}>('https://scrum-metrics.herokuapp.com/api/mailupd', userupd).subscribe((responseData) => {
      if (responseData.error) {
        alert('Error, refresh and try again');
      } else {
  ...
  updateAll(username: string, name: string, email: string) {
    ...
    this.http.put<{error: boolean}>('https://scrum-metrics.herokuapp.com/api/allupd', userupd).subscribe((responseData) => {
      if (responseData.error) {
        alert('Error, refresh and try again');
      } else {
