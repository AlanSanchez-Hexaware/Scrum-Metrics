...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
...
let NewProjectComponent = class NewProjectComponent {
    ...
    onAddProject(form) {
        ...
        const firstDate = form.value.inDate1;
        const lastDate = form.value.inDate2;
        const fixedDate = firstDate.getFullYear() + '-' + (firstDate.getMonth() + 1) + '-' + firstDate.getDate();
        let fixedlastDate;
...
let ProfileComponent = class ProfileComponent {
    ...
    changePass() {
        const dialogRef = this.dialog.open(_profilenewpass_profilenewpass_component__WEBPACK_IMPORTED_MODULE_5__["ProfilenewpassComponent"], {});
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
        });
    }
    deleteAccount() {
        const dialogRef = this.dialog.open(_deleteuser_deleteuser_component__WEBPACK_IMPORTED_MODULE_6__["DeleteuserComponent"], {});
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
        });
    }
...
let ProfilenewpassComponent = class ProfilenewpassComponent {
    constructor(dialogRef, userService) {
        this.dialogRef = dialogRef;
        this.userService = userService;
        this.username = sessionStorage.getItem('username');
...
ProfilenewpassComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: src_app_register_users_service__WEBPACK_IMPORTED_MODULE_3__["UserService"] }
];
...
let BoardComponent = class BoardComponent {
    constructor(router, projectsService, dialog) {
        this.router = router;
    ...
    onAddStory() {
        const dialogRef = this.dialog.open(_new_story_new_story_component__WEBPACK_IMPORTED_MODULE_6__["NewStoryComponent"], {});
        dialogRef.afterClosed().subscribe(result => {
            this.ngOnInit();
        });
    }
    onEditStory(story) {
        ...
        const dialogRef = this.dialog.open(_editstory_editstory_component__WEBPACK_IMPORTED_MODULE_7__["EditstoryComponent"], {});
        dialogRef.afterClosed().subscribe(result => {
...
let EditstoryComponent = class EditstoryComponent {
    constructor(dialogRef, projectService) {
        this.dialogRef = dialogRef;
        this.projectService = projectService;
...
let NewStoryComponent = class NewStoryComponent {
    constructor(dialogRef, projectService) {
        this.dialogRef = dialogRef;
        this.projectService = projectService;
        this.sprintid = sessionStorage.getItem('sprintid');
...
NewStoryComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: src_app_projects_service__WEBPACK_IMPORTED_MODULE_3__["ProjectsService"] }
];
...
let AddmemberComponent = class AddmemberComponent {
    constructor(dialogRef, userService, projectsService) {
        this.dialogRef = dialogRef;
        this.userService = userService;
        this.projectsService = projectsService;
        this.myControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"]();
    ...
    ngOnInit() {
        ...
        this.usersMap = this.userService.getUsersM();
        this.filteredOptions = this.myControl.valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(username => this._filter(username)));
    }
    _filter(value) {
        return this.usernames.filter(username => username.includes(value));
    }
...
let CurrentprojComponent = class CurrentprojComponent {
    constructor(router, projectService, usersService, dialog) {
        this.router = router;
        this.projectService = projectService;
    ...
    getProjectInfo() {
        this.projectService.getProjectInfo(this.projid).then((responseData) => {
            ...
            projinfo.forEach((Object) => {
                ...
                const start = Object['start_date'];
                const end = Object['end_date'];
    ...
    addUser() {
        const dialogRef = this.dialog.open(_addmember_addmember_component__WEBPACK_IMPORTED_MODULE_6__["AddmemberComponent"], {});
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
        });
    }
    addSprint() {
        const dialogRef = this.dialog.open(_newsprint_newsprint_component__WEBPACK_IMPORTED_MODULE_8__["NewsprintComponent"], {});
        dialogRef.afterClosed().subscribe(result => {
            console.log('The dialog was closed');
            this.ngOnInit();
        });
    ...
    newRole(userid) {
        ...
        const dialogRef = this.dialog.open(_newrole_newrole_component__WEBPACK_IMPORTED_MODULE_7__["NewroleComponent"], {});
        dialogRef.afterClosed().subscribe(result => {
...
CurrentprojComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: src_app_projects_service__WEBPACK_IMPORTED_MODULE_3__["ProjectsService"] },
    { type: src_app_register_users_service__WEBPACK_IMPORTED_MODULE_4__["UserService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatDialog"] }
...
let NewroleComponent = class NewroleComponent {
    constructor(dialogRef, projectsService) {
        this.dialogRef = dialogRef;
        this.projectsService = projectsService;
...
NewroleComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: src_app_projects_service__WEBPACK_IMPORTED_MODULE_3__["ProjectsService"] }
];
...
let NewsprintComponent = class NewsprintComponent {
    constructor(dialogRef, projectsService) {
        this.dialogRef = dialogRef;
        this.projectsService = projectsService;
        this.projid = sessionStorage.getItem('currprojid');
...
NewsprintComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: src_app_projects_service__WEBPACK_IMPORTED_MODULE_3__["ProjectsService"] }
];
...
let UserService = class UserService {
    ...
    setUser(name, email, username, password) {
        ...
        this.http.post(this.host + '/api/postuser', user).subscribe((responseData) => {
            alert(responseData.message);
            if (responseData.error) {
                return;
            }
    ...
    loginUser(username, password) {
        ...
        this.http.post(this.host + '/api/login', userLog).subscribe((responseData) => {
            if (responseData.error) {
                alert(responseData.message);
                return;
            }
    ...
    getUserInfo(username) {
        const user = { username };
        return this.http.post(this.host + '/api/user', user).subscribe((responseData) => {
    ...
    updateName(username, name) {
        ...
        this.http.put(this.host + '/api/nameupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
    ...
    updateMail(username, email) {
        ...
        this.http.put(this.host + '/api/mailupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
                alert('Error, refresh and try again');
            }
            else {
    ...
    updatePass(username, newpass) {
        ...
        this.http.put(this.host + '/api/passupd', passupd).subscribe((responseData) => {
            if (responseData.error) {
                alert('Error, refresh and try again');
            }
            else {
    ...
    updateAll(username, name, email) {
        ...
        this.http.put(this.host + '/api/allupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
                alert(responseData.message);
            }
            else {
    ...
    deleteAccount(userid, password) {
        ...
        this.http.post(this.host + '/api/deluser', deluser).subscribe((responseData) => {
            if (responseData.error) {
                alert(responseData.message);
            }
            else {
