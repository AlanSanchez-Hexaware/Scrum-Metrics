...
let ProjectsService = class ProjectsService {
    ...
    setProject(name, description, start_date, end_date, image) {
        ...
        let nameerror = false;
        this.http.post('http://192.168.0.108:3000/api/postproject', project).subscribe((responseData) => {
...
let UserService = class UserService {
    ...
    setUser(name, email, username, password) {
        ...
        this.http.post('http://192.168.0.108:3000/api/postuser', user).subscribe((responseData) => {
            alert(responseData.message);
            if (responseData.error) {
                return;
            }
    ...
    loginUser(username, password) {
        ...
        this.http.post('http://192.168.0.108:3000/api/login', userLog).subscribe((responseData) => {
            if (responseData.error) {
                alert(responseData.message);
                return;
            }
    ...
    getUserInfo(username) {
        const user = { username };
        return this.http.post('http://192.168.0.108:3000/api/user', user).subscribe((responseData) => {
    ...
    updateName(username, name) {
        ...
        this.http.put('http://192.168.0.108:3000/api/nameupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
    ...
    updateMail(username, email) {
        ...
        this.http.put('http://192.168.0.108:3000/api/mailupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
                alert('Error, refresh and try again');
            }
            else {
    ...
    updateAll(username, name, email) {
        ...
        this.http.put('http://192.168.0.108:3000/api/allupd', userupd).subscribe((responseData) => {
            if (responseData.error) {
                alert('Error, refresh and try again');
            }
            else {
